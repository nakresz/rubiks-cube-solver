...
GREEN_RED_F2L_CASES = [
    ...
    {
        "name": "green_red_case_31",
        "case_type": "corner_top_edge_top",
        "corner_position": "ULF",
        "corner_stickers": ["W", "R", "G"],
        "edge_position": "UL",
        "edge_stickers": ["R", "G"],
        "algorithm": ["L'", "U2", "L", "F'", "U'", "F"],
    },

    {
        "name": "green_red_case_32",
        "case_type": "corner_top_edge_top",
        "corner_position": "UFR",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UL",
    ...
    {
        "name": "green_red_case_33",
        "case_type": "corner_top_edge_top",
        "corner_position": "ULF",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UR",
        "edge_stickers": ["R", "G"],
        "algorithm": ["R2", "F2", "R2", "F", "U", "F"],
    },

    {
        "name": "green_red_case_34",
        "case_type": "corner_top_edge_top",
        "corner_position": "UBL",
        "corner_stickers": ["W", "R", "G"],
        "edge_position": "UR",
        "edge_stickers": ["G", "R"],
        "algorithm": ["R", "U", "R2", "F", "R", "F'"],
    },

    {
        "name": "green_red_case_35",
        "case_type": "corner_top_edge_top",
        "corner_position": "UFR",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UR",
    ...
    {
        "name": "green_red_case_36",
        "case_type": "corner_top_edge_top",
        "corner_position": "ULF",
        "corner_stickers": ["W", "R", "G"],
        "edge_position": "UF",
        "edge_stickers": ["R", "G"],
        "algorithm": ["F", "U'", "F2", "R'", "F", "R", "F"],
    },

    {
        "name": "green_red_case_37",
        "case_type": "corner_top_edge_top",
        "corner_position": "UFR",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UR",
        "edge_stickers": ["G", "R"],
        "algorithm": ["U'", "R2", "U", "R", "U'", "R2"],
    },

    {
        "name": "green_red_case_38",
        "case_type": "corner_top_edge_top",
        "corner_position": "UFR",
        "corner_stickers": ["G", "W", "R"],
        "edge_position": "UF",
        "edge_stickers": ["R", "G"],
        "algorithm": ["U", "F2", "U'", "F'", "U", "F2"],
    },

    {
        "name": "green_red_case_39",
        "case_type": "corner_top_edge_top",
        "corner_position": "ULF",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UB",
        "edge_stickers": ["R", "G"],
        "algorithm": ["U2", "R", "F", "R", "F'", "R'"],
    },

    {
        "name": "green_red_case_40",
        "case_type": "corner_top_edge_middle",
        "corner_position": "URB",
        "corner_stickers": ["W", "R", "G"],
        "edge_position": "BL",
        "edge_stickers": ["G", "R"],
        "algorithm": ["U2", "L'", "U2", "F2", "L'", "F2", "L"],
    },

    {
        "name": "green_red_case_41",
        "case_type": "corner_top_edge_top",
        "corner_position": "UFR",
        "corner_stickers": ["R", "G", "W"],
        "edge_position": "UB",
